...
export default class Agents extends Component {
  ...
  doRender() {
    ...
    if (this.state.failed) {
      return (
        <NavItem className="btn btn-danger disabled btn-sm mx-1">
    ...
    if (!agents) {
      return (
        <NavItem className="btn btn-warning disabled btn-sm mx-1">
  ...
  renderAgent(agent) {
    let buttonClass = "btn disabled btn-sm mx-1 btn-success";
    let iconClass = "fa fa-fw fa-check";
